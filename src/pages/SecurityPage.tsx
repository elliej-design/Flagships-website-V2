      ...
      <div className="security-container">
        <article className="security-content">
          ...
          <div className="security-principles">
            <h2 className="security-section-title">Multi-Layer Protection</h2>
            ...
            <h2 className="security-section-title">Zero Trust & Granular Control</h2>
            <p className="security-paragraph">
            ...
            <h2 className="security-section-title">Transparent Governance & Compliance</h2>
            <p className="security-paragraph">
            ...
            <h2 className="security-section-title">A Partnership You Can Trust</h2>
            <p className="security-paragraph">
          ...
          <div className="security-commitment">
            <h2 className="security-section-title">Your Data. Our Commitment.</h2>
            <p className="security-paragraph">
